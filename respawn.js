    ...
    this.muere = function(ws, idPersonaje) {
        ...
        if (pjSelected.hp <= 0) {
            if (!pjSelected.isNpc) {
                ...
                pjSelected.hp = 0;
                if (
                    !pjSelected.navegando &&
                    vars.mapa[pjSelected.map][pjSelected.pos.y][
                        pjSelected.pos.x
                    ].trigger != 6
                ) {
            ...
            if (expGanada > 0) {
                ...
                handleProtocol.console(
                    "¡Has ganado " + expGanada + " puntos de experiencia!",
                    "red",
                    1,
                    0,
                    ws
            ...
            if (goldGanado > 0) {
                ...
                handleProtocol.console(
                    "¡Has ganado " + goldGanado + " monedas de oro!",
                    "red",
                    1,
                    0,
                    ws
            ...
            if (pjSelected.isNpc) {
                handleProtocol.console(
                    "¡Has matado a " +
                        vars.npcs[idPersonaje].nameCharacter +
                        "!",
                    "red",
                    1,
                    0,
